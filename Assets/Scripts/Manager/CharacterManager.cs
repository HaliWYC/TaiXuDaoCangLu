...
{
    private Dictionary<int, Jingjie> JingjieDataList = new();
    ...
    private void CSVToJingjieData()
    {
        ...
        for (var i = 1; i < data.Count; i++)
        {
            ...
            var jingjieData = ScriptableObject.CreateInstance<JingjieData>();
            ...
            JingjieDataList.Add(jingjie.ID, jingjie);
        }
    }
    
    public Jingjie GetJingjie(int id)
    {
        return JingjieDataList[id];
    }
}